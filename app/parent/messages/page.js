...
export default function ParentMessagesPage() {
  ...
  const contacts = [
    { id: 1, name: "Mr. Smith (Math)", lastMessage: "She did great on the math quiz.", unread: 1, time: "10:00 AM" },
    { id: 2, name: "Ms. Davis (Science)", lastMessage: "Can we schedule a meeting?", unread: 0, time: "Yesterday" }
  ];
  ...
  const messages = {
    ...
    2: [
      ...
      { id: 203, text: "Yes, I am available tomorrow at 3 PM.", sender: "teacher", time: "09:30 AM" }
    ]
  };
